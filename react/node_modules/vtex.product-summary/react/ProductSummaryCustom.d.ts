...
declare function ProductSummaryWrapper({ product, actionOnClick, href, priceBehavior, trackListName, listName, position, sponsoredBadgePosition, sponsoredBadgeLabel, placement, classes, children, }: PropsWithChildren<Props>): JSX.Element;
